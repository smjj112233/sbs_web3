...
$(function () {
  ...
  for (let i = 0; i < initNum; i++) {
    // A.prependTo(B)  : A를 부모요소(B)의 가장 첫 번째 자식 요소로 추가
  ...
  /* (가운데-첫번째 슬라이드) 페이드 인 */
  $(".slide-item:nth-child(" + (initNum + 1) + ") img").removeClass(
    "bright-10"
  );
  ...
  $(".prev").on("click", () => {
    ...
    $(".slide-item:nth-child(" + (initNum + 1) + ") img").addClass(
      "bright-100"
    );
